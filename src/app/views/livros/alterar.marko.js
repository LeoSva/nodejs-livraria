...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocodigo$1.0.0/src/app/views/livros/alterar.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><title>Alteração de documentos</title></head><body>");

  component_globals_tag({}, out);

  out.w("<h1>Alteração de livro</h1><form action=\"/livros\" method=\"post\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
...
marko_template.meta = {
    id: "/casadocodigo$1.0.0/src/app/views/livros/alterar.marko",
    tags: [
